    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> EmailCategory(EmailCategoryViewModel ecvm)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Index", "Categories", new {swalMessage = "Success: EmailSent" });
                }
                catch
                {
                    return RedirectToAction("Index", "Categories", new { swalMessage = "Success: Email hasn't been sent" });
                    throw;
                }
            }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,AppUserId,Name")] Category category)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    //make sure this appUserId belongs to the currently login person
                    string appUserId = _userManager.GetUserId(User);
